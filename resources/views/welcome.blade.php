...
<div class="container">
	...
	<div class="navbar-collapse collapse" id="navbarColor02" style="">
		<ul class="navbar-nav mr-auto d-flex align-items-center">
			...
			<li class="nav-item">
			<a class="nav-link" href="./article.html">Cara Kerja</a>
			</li>
			<li class="nav-item">
			<a class="nav-link" href="./article.html">Barang Tersedia</a>
			</li>
		</ul>
		...
		<div class="pl-4 pr-0 h-100 tofront">
			<div class="row justify-content-between">
				<div class="col-md-6 pt-6 pb-6 align-self-center">
					<h1 class="secondfont mb-3 font-weight-bold">Ingatin adalah sebuah situs untuk menyimpan segala peminjaman yang anda lakukan, </h1>
					<p class="mb-3">
                            kami akan mengingatkan anda untuk mengembalikan barang yang anda pinjam dari teman anda!					</p>
					<a href="./article.html" class="btn btn-dark">Cara Kerja</a>
				</div>
...
<div class="container mt-5">
	...
	<div class="row align-items-center justify-content-between">
		<div>
            <span class="navbar-brand mr-2"><strong>{{ config('app.name', 'Laravel') }}</strong></span> Copyright &copy;
